...
/* 
   12 August 2014: Ported to PL/C on Greenplum MPP by Srivatsan Ramanujam <sramanujam@pivotal.io>
*/
...
/*
 Postgres headers for PL/C (Srivatsan Ramanujam)
*/
#include <postgres.h>
#include <fmgr.h>
#include <sys/time.h>
...
/*
 Plug in PL/C call to be invoked via SQL
*/
PG_FUNCTION_INFO_V1(plc_stem_token);
