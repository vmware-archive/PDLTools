...
function(define_m4_macros OUT_M4_CMD_LINE OUT_M4_CODE)
    ...
    set(MACROS
        ...
        "__PDLTOOLS_VERSION__=${PDLTOOLS_VERSION_STRING}"
        "__PDLTOOLS_VERSION_MAJOR__=${PDLTOOLS_VERSION_MAJOR}"
        "__PDLTOOLS_VERSION_MINOR__=${PDLTOOLS_VERSION_MINOR}"
        "__PDLTOOLS_VERSION_PATCH__=${PDLTOOLS_VERSION_PATCH}"
        "__PDLTOOLS_GIT_REVISION__=${PDLTOOLS_GIT_REVISION}"
        "__PDLTOOLS_BUILD_TIME__=${PDLTOOLS_BUILD_TIME}"
        "__PDLTOOLS_BUILD_TYPE__=${CMAKE_BUILD_TYPE}"
        "__PDLTOOLS_BUILD_SYSTEM__=${CMAKE_SYSTEM}"
        "__PDLTOOLS_C_COMPILER__=${PDLTOOLS_C_COMPILER}"
        "__PDLTOOLS_CXX_COMPILER__=${PDLTOOLS_CXX_COMPILER}"
        ${IN_FEATURES}
    )
